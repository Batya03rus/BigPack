...
namespace BigPack
{
    ...
    public partial class AyurEntities : DbContext
    {
        public AyurEntities()
            : base("name=AyurEntities")
        {
        }

        private static AyurEntities _context;

        public static AyurEntities GetContext()
        {
            if (_context == null) _context = new AyurEntities();
            return _context;
        }
